...
import { findAllByBooksByOwner } from '../fn/book/find-all-by-books-by-owner';
import { FindAllByBooksByOwner$Params } from '../fn/book/find-all-by-books-by-owner';
...
export class BookService extends BaseService {
  ...
  /** Path part for operation `findAllByBooksByOwner()` */
  static readonly FindAllByBooksByOwnerPath = '/books/owner';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `findAllByBooksByOwner()` instead.
   *
   * This method doesn't expect any request body.
   */
  findAllByBooksByOwner$Response(params?: FindAllByBooksByOwner$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseBookResponse>> {
    return findAllByBooksByOwner(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `findAllByBooksByOwner$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  findAllByBooksByOwner(params?: FindAllByBooksByOwner$Params, context?: HttpContext): Observable<PageResponseBookResponse> {
    return this.findAllByBooksByOwner$Response(params, context).pipe(
      map((r: StrictHttpResponse<PageResponseBookResponse>): PageResponseBookResponse => r.body)
    );
  }
