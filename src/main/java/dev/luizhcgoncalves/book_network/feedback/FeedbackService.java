...
import dev.luizhcgoncalves.book_network.book.BookRepository;
...
public class FeedbackService {
    ...
    public Integer save(FeedbackRequest request, Authentication connectedUser) {
        ...
        if (book.isArchived() || !book.isShareable()) {
            throw new OperationNotPermittedException("The desired book is archived or not available to be reviewed.");
        }
    ...
    public PageResponse<FeedbackResponse> findAllFeedbacksByBook(Integer bookId, int page, int pageSize, Authentication connectedUser) {
